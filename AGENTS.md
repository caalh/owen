...
the VS Code Marketplace and Open VSX); **v0.3.7 is built locally (VSIX) but not yet published**.
It is a **BelvoirDynamics** product; its siblings are the **GROVES** desktop app (v1.3.2) and
