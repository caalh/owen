...
Current release: **v1.0.0** (stable, built locally as VSIX; GitHub Release v1.0.0).
**v0.3.1 remains the published Marketplace / Open VSX version** until the maintainer
publishes 1.0.0.
